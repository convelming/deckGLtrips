import { registerShaderModules, setDefaultShaderModules, fp32, fp64, project, // lighting,
dirlight, picking, diffuse } from 'luma.gl';
...
test('shadertools#module imports are defined', t => {
  ...
  t.ok(project, 'project is defined'); // TODO: looks like lighting is not correctly imported and we should be using
