...
function assembleShader(gl, {
  ...
  let glslVersion = 100;
  let versionLine = '';
  let coreSource = source; // Extract any version directive string from source.
  ...
  for (const module of modules) {
    switch (module.name) {
      ...
      default:
        ...
        const moduleSource = module.getModuleSource(type, glslVersion); // Add the module source, and a #define that declares it presence
