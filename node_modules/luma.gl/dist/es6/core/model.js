...
const LOG_DRAW_TIMEOUT = 10000; // These old picking uniforms should be avoided and we should use picking module
...
export default class Model extends Object3D {
  constructor(gl, props = {}) {
    ...
    this.initialize(props); // intended to be subclassed, do not seal
  }
  ...
  initialize(props = {}) {
    ...
    this.onAfterRender = props.onAfterRender || (() => {}); // assert(program || program instanceof Program);
  ...
  setAttributes(attributes = {}) {
    ...
    const buffers = this._createBuffersFromAttributeDescriptors(attributes); // Object.assign(this.attributes, buffers);
  ...
  _extractAnimatedUniforms(uniforms) {
    let foundAnimated = false; // Keep our animatedUniforms map up-to-date
...
count: ${this.stats.profileFrameCount}`)();
  ...
  _createBuffersFromAttributeDescriptors(attributes) {
    const gl = this.program.gl; // const attributes = {};
