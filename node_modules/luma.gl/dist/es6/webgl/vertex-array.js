...
export default class VertexArray {
  constructor(gl, opts = {}) {
    ...
    const id = opts.id || opts.program && opts.program.id; // super(gl, Object.assign({}, opts, {id}));
  ...
  _resolveLocationAndAccessor(locationOrName, value, valueAccessor, appAccessor) {
    ...
    const accessInfo = this._getAttributeInfo(locationOrName); // Resolve the partial accessors into a final accessor
  ...
  _setConstantAttributeZero(constant, elementCount) {
    ...
    const buffer = this.vertexArrayObject.getConstantBuffer(elementCount, constant); // Set the buffer on location 0
