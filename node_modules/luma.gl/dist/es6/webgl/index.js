...
export { getContextInfo } from '../webgl-context/context-limits'; // Functions

export { clear } from './clear';
export { parseUniformName, getUniformSetter } from './uniforms'; // WebGL1 objects
...
export { default as TextureCube } from './texture-cube'; // WebGL2 objects
