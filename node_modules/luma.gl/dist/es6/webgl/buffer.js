...
export default class Buffer extends Resource {
  constructor(gl, props = {}) {
    super(gl, props);
    this.stubRemovedMethods('Buffer', 'v6.0', ['layout', 'setLayout', 'getIndexedParameter']); // In WebGL1, need to make sure we use GL.ELEMENT_ARRAY_BUFFER when initializing element buffers
  ...
  subData(props) {
    ...
    const byteLength = props.byteLength || props.length; // if (byteLength > this.byteLength) {
  ...
  _initialize(props = {}) {
    ...
    const byteLength = props.byteLength || props.bytes || 0; // assert(props.data || byteLength);
