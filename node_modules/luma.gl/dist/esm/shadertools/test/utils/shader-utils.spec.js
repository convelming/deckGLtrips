import { getQualifierDetails, getPassthroughFS, typeToChannelSuffix, typeToChannelCount, convertToVec4 } from '../../src/utils/shader-utils';
import test from 'tape-catch';
test('shader-utils#getQualifierDetails', function (t) {
...
test('shader-utils#typeToChannelSuffix', function (t) {
...
test('shader-utils#typeToChannelCount', function (t) {
...
test('shader-utils#convertToVec4', function (t) {
  t.equal(convertToVec4('one', 'float'), 'vec4(one, 0.0, 0.0, 1.0)', 'convertToVec4 should return right value for float');
  t.equal(convertToVec4('one', 'vec2'), 'vec4(one, 0.0, 1.0)', 'convertToVec4 should return right value for vec2');
  t.equal(convertToVec4('one', 'vec3'), 'vec4(one, 1.0)', 'convertToVec4 should return right value for vec3');
