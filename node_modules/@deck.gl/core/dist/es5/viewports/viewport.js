  ...
  _createClass(Viewport, [{
    ...
    value: function _initViewMatrix(opts) {
      ...
      if (this.isGeospatial) {
        ...
        this.viewMatrixUncentered = (0, _scale.default)([], viewMatrix, [1, -1, 1]); // Make a centered version of the matrix for projection modes without an offset
    ...
    value: function _initPixelMatrices() {
      ...
      (0, _scale.default)(viewportMatrix, viewportMatrix, [this.width / 2, -this.height / 2, 1]);
      (0, _translate.default)(viewportMatrix, viewportMatrix, [1, -1, 0]);
      (0, _multiply.default)(pixelProjectionMatrix, viewportMatrix, this.viewProjectionMatrix);
